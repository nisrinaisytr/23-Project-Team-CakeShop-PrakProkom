...
def buat_cakes_page(app):
    ...
    takeaway_button = ctk.CTkButton(action_frame,width=240, text="TAKEAWAY", fg_color='white', text_color=button_color, command=lambda: proceed_to_selection( "TAKEAWAY", selected_products,app))
    takeaway_button.grid(row=0, column=0, padx=10, pady=5)
    delivery_button = ctk.CTkButton(action_frame, width=240,text="DELIVERY", fg_color='white', text_color=button_color, command=lambda: proceed_to_selection( "DELIVERY", selected_products,app))
    delivery_button.grid(row=0, column=1, padx=10, pady=5)
    dinein_button = ctk.CTkButton(action_frame, width=240,text="DINE IN", fg_color='white', text_color=button_color, command=lambda: proceed_to_selection( "DINE IN", selected_products,app))
