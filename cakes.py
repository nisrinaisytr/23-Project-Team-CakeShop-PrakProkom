...
title_label = ctk.CTkLabel(header_frame, text="CAKES",justify="center", font=font_title)
title_label.pack(side=tk.TOP, pady=15)

# Menampilkan menu produk dari database/cakes.csv
