...
def signup():
    ...
    if password==conform_password:
        ...
        messagebox.showerror('Invalid',"Password harus sama")
...
def on_leave(e):
    if conform_code.get()=='':
        conform_code.insert(0,'Ulang Password')

conform_code=Entry(frame,width=25,fg='black',border=0,bg='white',font=('Microsoft YaHei UI Light',11))
conform_code.place(c=30,y=220)
conform_code.insert(0, 'Ulang Password')
