...
def buat_breads_page(app):
    ...
    #def go_back():
    # Save cart to CSV before going back
        #app.destroy()
    ...
    takeaway_button = ctk.CTkButton(action_frame,width=240, text="TAKEAWAY", fg_color='white',text_color='#C27767',command=lambda: button.menuju_ke_pemilihan(app, "TAKEAWAY", selected_products))
    takeaway_button.grid(row=0, column=0, padx=10, pady=5, sticky="ew")
    delivery_button = ctk.CTkButton(action_frame,width=240, text="DELIVERY", fg_color='white',text_color='#C27767', command=lambda: button.menuju_ke_pemilihan(app, "DELIVERY", selected_products))
    delivery_button.grid(row=0, column=1, padx=10, pady=5, sticky="ew")
    dinein_button = ctk.CTkButton(action_frame,width=240, text="DINE IN", fg_color='white',text_color='#C27767', command=lambda: button.menuju_ke_pemilihan(app, "DINE IN", selected_products))
